...
# Input dataset (train)
cfg.fake_data_provider = lambda: ResizeDataProvider("Test", 1, default_batch_size=cfg.batch_size)
# Input dataset (test)
cfg.fake_data_provider_test = lambda: ResizeDataProvider("Test", 1, default_batch_size=cfg.batch_size)
# Target dataset
cfg.real_data_provider = lambda: ResizeDataProvider("Test", 0, default_batch_size=cfg.batch_size)
